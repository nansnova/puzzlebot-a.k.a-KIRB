...
# Args: imagePath (string) - the image path
#       colorCode(int) - the color code 
# https://docs.opencv.org/4.5.5/d8/d6a/group__imgcodecs__flags.html#ga61d9b0126a3e57d9277ac48327799c80
...
# Args: imageName (string) - window title
#       inputImage (np array) - the image to be displayed
#       fixedWindow (bool) - resizing flag
#       delay (int) - auto-close delay in milliseconds. 
#                     0 is means "forever", press any key to close
...
# Writes an PGN image:
# Args: imagePath (string) - image destiny path
#       inputImage (np array) - image to be written
